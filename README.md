...
prebuilt builder otherwise stripped the Rust engine even though Next's trace
manifest listed it. The deploy workflow verifies the engine in
`.vercel/output/functions` before uploading a deployment.
