...
export const APP_COPY = {
  ...
  fr: {
    ...
    dashboard: {
      ...
      tasksStartAction: "Aller à Tâches",
  ...
  pt: {
    ...
    dashboard: {
      ...
      tasksStartAction: "Ir para Tarefas",
