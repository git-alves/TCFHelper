...
export const APP_COPY = {
  ...
  es: {
    ...
    dashboard: {
      ...
      practiceStartAction: "Ir a Entrenamiento",
      ...
      tasksStartAction: "Ir a Simulación",
    ...
    walkthrough: {
      ...
      skip: "Omitir",
      finish: "Finalizar",
      continueToPractice: "Continuar a Entrenamiento",
      continueToFullTask: "Continuar a Simulación",
      ...
      dashboardPracticeBody: "Entrenamiento te ayuda a ensayar una parte numerada de una tarea TCF en tu nivel objetivo antes de escribir una respuesta completa.",
      dashboardStartWritingTitle: "¿Listo para una tarea completa?",
      dashboardStartWritingBody: "Abre Simulación para elegir una consigna de examen y obtener tu primera corrección.",
      practiceIntroTitle: "Entrenamiento desarrolla una parte de la tarea",
  ...
  pt: {
    ...
    dashboard: {
      ...
      practiceStartAction: "Ir para Treino",
      ...
      tasksStartAction: "Ir para Simulação",
    ...
    walkthrough: {
      ...
      skip: "Pular",
      finish: "Concluir",
      continueToPractice: "Continuar para Treino",
      continueToFullTask: "Continuar para Simulação",
      ...
      dashboardPracticeBody: "Treino ajuda você a ensaiar uma parte numerada de uma tarefa TCF no seu nível-alvo antes de escrever uma resposta completa.",
      dashboardStartWritingTitle: "Pronto para uma tarefa completa?",
      dashboardStartWritingBody: "Abra Simulação para escolher um enunciado de exame e receber sua primeira correção.",
      practiceIntroTitle: "Treino desenvolve uma parte da tarefa",
