...
export const APP_COPY = {
  en: {
    ...
    walkthrough: {
      ...
      supportBody: "Report a bug, ask a question, or share an idea. Support sends it as your signed-in account, so a reply reaches you directly.",
  ...
  fr: {
    ...
    walkthrough: {
      ...
      supportBody: "Signalez un bug, posez une question ou partagez une idée. L’assistance l’envoie depuis votre compte connecté, pour que la réponse vous parvienne directement.",
  ...
  es: {
    ...
    walkthrough: {
      ...
      supportBody: "Informa un error, haz una pregunta o comparte una idea. Soporte lo envía desde tu cuenta conectada, para que la respuesta te llegue directamente.",
  ...
  pt: {
    ...
    walkthrough: {
      ...
      supportBody: "Relate um bug, faça uma pergunta ou compartilhe uma ideia. O Suporte envia a partir da sua conta conectada, para que a resposta chegue direto a você.",
