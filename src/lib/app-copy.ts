...
export const APP_COPY = {
  en: {
    ...
    practice: {
      ...
      sequenceDescription: ({ count }) => `This sequence contains ${count} curated exercises in a varied order.`,
  ...
  fr: {
    ...
    practice: {
      ...
      sequenceDescription: ({ count }) => `Cette séquence contient ${count} exercices sélectionnés dans un ordre varié.`,
  ...
  es: {
    ...
    practice: {
      ...
      sequenceDescription: ({ count }) => `Esta secuencia contiene ${count} ejercicios seleccionados en un orden variado.`,
  ...
  pt: {
    ...
    practice: {
      ...
      sequenceDescription: ({ count }) => `Esta sequência contém ${count} exercícios selecionados em uma ordem variada.`,
