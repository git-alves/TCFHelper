...
export interface AppCopy {
  ...
  practice: {
    ...
    developShowStructureAid: string;
    developHideStructureAid: string;
    developContextLabel: string;
    developContextPlaceholder: string;
    developObjectiveLabel: string;
  ...
  walkthrough: {
    ...
    spellCheckTourTitle: string;
    spellCheckTourBody: string;
    editorTitle: string;
    editorBody: string;
...
export const APP_COPY = {
  en: {
    ...
    practice: {
      ...
      developShowStructureAid: "Need a structure?",
      developHideStructureAid: "Hide structure aid",
      developContextLabel: "Context (optional)",
      developContextPlaceholder: "Who are you writing to, and why?",
      developObjectiveLabel: "Objective / action (optional)",
    ...
    dashboard: {
      ...
      continuePractice: "Continue Train",
    ...
    walkthrough: {
      ...
      skip: "Skip",
      finish: "Finish",
      continueToPractice: "Continue to Train",
      continueToFullTask: "Continue to Simulate",
      ...
      dashboardPracticeBody: "Train helps you rehearse one numbered part of a TCF task at your target level before you attempt a complete response.",
      dashboardStartWritingTitle: "Ready to Simulate a Task?",
      dashboardStartWritingBody: "Open Simulate to choose an exam prompt and get your first correction.",
      practiceIntroTitle: "Train builds a part of the task",
      ...
      practiceStagesBody: "Every part follows the same fixed plan: Recognise, Complete, Transform, Organise, Develop, then Produce. Each stage removes a little more support, so you finish able to write it yourself. When you are ready, open Simulate to apply what you trained in a complete TCF response.",
  ...
  fr: {
    ...
    practice: {
      ...
      developShowStructureAid: "Besoin d'une structure ?",
      developHideStructureAid: "Masquer l'aide à la structure",
      developContextLabel: "Contexte (facultatif)",
      developContextPlaceholder: "À qui écrivez-vous, et pourquoi ?",
      developObjectiveLabel: "Objectif / action (facultatif)",
    ...
    dashboard: {
      ...
      practiceStartAction: "Aller à Entraînement",
      tasksStartTitle: "Simuler une tâche",
      tasksStartDescription: "Rédigez une réponse TCF complète, puis recevez des commentaires sur votre rédaction.",
      tasksStartAction: "Aller à Simulation",
    ...
    walkthrough: {
      ...
      skip: "Ignorer",
      finish: "Terminer",
      continueToPractice: "Continuer vers Entraînement",
      continueToFullTask: "Continuer vers Simulation",
      ...
      dashboardPracticeBody: "Entraînement vous aide à travailler une partie numérotée d’une tâche TCF à votre niveau cible avant de rédiger une réponse complète.",
      dashboardStartWritingTitle: "Prêt·e à simuler une tâche ?",
      dashboardStartWritingBody: "Ouvrez Simulation pour choisir une consigne d’examen et obtenir votre première correction.",
      practiceIntroTitle: "Entraînement construit une partie de la tâche",
  ...
  es: {
    ...
    practice: {
      ...
      developShowStructureAid: "¿Necesitas una estructura?",
      developHideStructureAid: "Ocultar ayuda de estructura",
      developContextLabel: "Contexto (opcional)",
      developContextPlaceholder: "¿A quién le escribes y por qué?",
      developObjectiveLabel: "Objetivo / acción (opcional)",
    ...
    walkthrough: {
      ...
      skip: "Omitir",
      finish: "Finalizar",
      continueToPractice: "Continuar a Entrenar",
      continueToFullTask: "Continuar a Simular",
      ...
      dashboardPracticeBody: "Entrenar te ayuda a ensayar una parte numerada de una tarea TCF en tu nivel objetivo antes de escribir una respuesta completa.",
      dashboardStartWritingTitle: "¿Listo para simular una tarea?",
      dashboardStartWritingBody: "Abre Simular para elegir una consigna de examen y obtener tu primera corrección.",
      practiceIntroTitle: "Entrenar desarrolla una parte de la tarea",
  ...
  pt: {
    ...
    practice: {
      ...
      tryFullTask: "Simular uma tarefa",
      ...
      developShowStructureAid: "Precisa de uma estrutura?",
      developHideStructureAid: "Ocultar ajuda de estrutura",
      developContextLabel: "Contexto (opcional)",
      developContextPlaceholder: "Para quem você está escrevendo, e por quê?",
      developObjectiveLabel: "Objetivo / ação (opcional)",
    ...
    dashboard: {
      ...
      practiceStartAction: "Ir para Treinar",
      tasksStartTitle: "Simular uma tarefa",
      tasksStartDescription: "Escreva uma resposta TCF completa e receba feedback sobre sua escrita.",
      tasksStartAction: "Ir para Simular",
      ...
      continuePractice: "Continuar treinando",
    ...
    walkthrough: {
      ...
      skip: "Pular",
      finish: "Concluir",
      continueToPractice: "Continuar para Treinar",
      continueToFullTask: "Continuar para Simular",
      dashboardWelcomeTitle: "Bem-vindo ao MyTCFLab",
      dashboardWelcomeBody:
        "Este é o seu Dashboard — seu nível QECR ao longo do tempo e suas correções recentes aparecerão aqui depois de algumas redações.",
      ...
      dashboardPracticeBody: "Treinar ajuda você a ensaiar uma parte numerada de uma tarefa TCF no seu nível-alvo antes de escrever uma resposta completa.",
      dashboardStartWritingTitle: "Pronto para simular uma tarefa?",
      dashboardStartWritingBody: "Abra Simular para escolher um enunciado de exame e receber sua primeira correção.",
      practiceIntroTitle: "Treinar desenvolve uma parte da tarefa",
    ...
    workspace: {
      ...
      dialog: {
        ...
        dashboardSwitchDescription: "Ir para o Dashboard descartará o enunciado, o rascunho e os comentários atuais.",
