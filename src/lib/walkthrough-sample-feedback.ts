...
export function getWalkthroughSampleFeedback(copy: AppCopy): EssayFeedback {
  ...
  return {
    ...
    cefr: {
      ...
      confidence: "Medium",
      rationale: preview.cefrRationale,
      evidence: preview.cefrEvidence,
      blocker: preview.cefrBlocker,
    },
    meetsWordCount: true,
    wordCountNote: preview.wordCountNote,
    errors: [
      {
        originalText: agreementOriginal,
        originalStart: WALKTHROUGH_SAMPLE_ESSAY.indexOf(agreementOriginal),
        correctedText: agreementCorrection,
      ...
      {
        originalText: participleOriginal,
        originalStart: WALKTHROUGH_SAMPLE_ESSAY.indexOf(participleOriginal),
        correctedText: participleCorrection,
