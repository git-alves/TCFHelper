  ...
  it("returns complete, renderable static copy for each locale", () => {
    for (const locale of APP_LOCALES) {
      ...
      const renderedCopy = [
        ...
        copy.practice.availableLevel({ level: "B2", topics: 1 }),
  ...
  it("has complete practice-mode interface copy for every locale", () => {
    for (const locale of APP_LOCALES) {
      ...
      const values = [
        ...
        practice.availableLevel({ level: "B2", topics: 1 }),
        practice.skillHelp,
